          ...
          <div className='mx-auto flex-wrap text-gray-800 dark:text-gray-200 md:flex'>
            <div className='grid grid-cols-1 lg:grid-cols-2'>
              <div className='relative mx-auto ml-0 mt-8 space-y-8 text-left font-content md:mt-16 md:max-w-lg lg:max-w-2xl'>
                <p className=''>
                  கர்பகுடி IVF மையம், முன்னணி கருத்தரிப்பு (fertility) மருத்துவமையங்களில் ஒன்றாகும்.
                  இங்கு IVF சிகிச்சை உள்ளிட்ட பல்வேறு கருத்தரிப்பு சிகிச்சைகள் வழங்கப்படுகின்றன.
                  <br />
                  <br />
                ...
                <p>
                  கர்பகுடி IVF மையத்தில் நவீன உபகரணங்களுடன் கூடிய ஆய்வகம், அனுபவமிக்க மருத்துவர்
