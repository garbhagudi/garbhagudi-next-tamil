...
export default function Footer() {
  return (
    <footer className='flex flex-col items-center gap-3 bg-charcoal px-6 py-10 text-center text-white/70'>
      <div className='mb-1 font-serif-tamil text-[1.2rem] font-bold text-white'>
        கர்பகுடி கருத்தரித்தல் மையம் – ஓசூர்
      </div>
      <div className='mt-1 font-serif-tamil text-[13px] text-white/75'>
