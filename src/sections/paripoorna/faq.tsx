...
const FAQ = () => {
  ...
  return (
    <div className='mx-auto max-w-4xl px-3 pb-10 text-justify lg:px-0'>
      <h3 className='text 3xl py-10 text-center font-lexend font-bold text-gray-800 dark:text-gray-200 lg:py-16 lg:text-4xl'>
