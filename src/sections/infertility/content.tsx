    ...
    <div className='mx-auto max-w-7xl px-3 text-gray-800 dark:text-gray-200'>
      <div className='py-3 lg:py-8'>
        ...
        <div className='font-content'>
          ...
          <div className='pb-4'>
            கருத்தரிக்க முடியாமை சிகிச்சை என்பது இயற்கையாக கருவுற சிரமப்படும் தம்பதிகளுக்கு
            உதவுவதற்கான முழுமையான அணுகுமுறை ஆகும். ஓசூரில் சிறந்த கருத்தரிப்பு சிகிச்சையை
            நாடுபவர்களுக்கு, <strong>கர்பகுடி IVF மையம்</strong> முன்னோடியான தீர்வுகளையும்,
          ...
          <div>
            <span className='font-bold'>கர்பகுடி IVF மையத்தில், </span>
          ...
          <div className='pb-4'>
            ஓசூரில் முன்னணி கருத்தரிக்க முடியாமை சிகிச்சையை <strong>கர்பகுடி IVF மையத்தில் </strong>{' '}
            அனுபவித்து, பெற்றோராகும் உங்கள் பாதையை நம்பிக்கையுடன் தொடங்குங்கள்.
          </div>
          <div className='pb-4'>
            சிறந்த கருத்தரிப்பு சிகிச்சையை நாடுபவர்களுக்கு, <strong>கர்பகுடி IVF மையம் </strong>{' '}
    ...
    <div className='mx-auto max-w-7xl px-3 text-gray-800 dark:text-gray-200'>
      <div className='py-3 lg:py-8'>
        <div className='py-3 font-heading text-3xl font-bold'>
          ஓசூரில் கருத்தரிக்க முடியாமை சிகிச்சை செயல்முறை என்ன? – பெற்றோராகும் பாதையில் வழிகாட்டுதல்
        </div>
        <div className='space-y-4 font-content'>
          <div>
            ஓசூரில் முன்னணி கருத்தரிப்பு மையமான கர்பகுடி IVF மையத்தில், நாங்கள் நோயாளி
          ...
          <div>
            கர்பகுடி IVF மையத்தில், கருத்தரிக்க முடியாமை ஏற்படுத்தும் மனஉளைச்சலும் உடல்
  ...
  return (
    <div className='mx-auto max-w-7xl px-3 text-gray-800 dark:text-gray-200'>
      <div className='py-3 lg:pt-8'>
        <div className='py-3 font-heading text-3xl font-bold'>
          ஏன் கர்பகுடி ஓசூரில் சிறந்த கருத்தரிப்பு மருத்துவமனை? – கருத்தரிப்பு சிகிச்சையில் முன்னோடி
        </div>
        <div className='font-content'>
          <div className='pb-4'>
            <span className='font-bold'>கர்பகுடி ஐவிஎஃப் மையம்,</span>.சிறப்பின் உச்சமாக திகழ்ந்து,
            ஓசூரில் சிறந்த கருத்தரிப்பு மருத்துவமனையாக அறியப்படுகிறது. ஒவ்வொரு தம்பதியரும் தனிப்பட்ட
            பராமரிப்பு மற்றும் அக்கறை பெறுவதை உறுதி செய்ய, பல்வேறு தேவைகளுக்குத் தகுந்த விரிவான
            கருத்தரிப்பு சிகிச்சைகளை நாங்கள் வழங்குகிறோம்.
          </div>{' '}
          <div className='pb-4'>
  ...
  return (
    <div className='mx-auto max-w-7xl px-3 text-gray-800 dark:text-gray-200'>
      <div className='pb-3 font-heading text-3xl font-bold lg:pb-5'>
        ஓசூரில் சிறந்த மலட்டுத்தன்மை சிகிச்சை - பெற்றோராக உங்கள் பாதையை மேம்படுத்துதல்
      </div>
      <div className='mx-auto flex max-w-7xl flex-col items-center justify-center pb-4 lg:flex-row lg:pb-8'>
        ...
        <div className='px-0 pt-3 font-content text-gray-800 dark:text-gray-200 lg:w-1/2 lg:px-8 lg:pt-0'>
          <p className=''>
            ஓசூரில் உள்ள எங்கள் நவீன மருத்துவ மையத்தில், தம்பதிகள் எதிர்கொள்ளும் பல்வேறு
