...
export const TreatmentHeader = {
  female: [
    ...
    },
    {
      ...
      link: '/treatments/laparoscopy-treatment-in-hosur',
    },
    {
      id: '7',
      name: 'ஹிஸ்டரஸ்கோப்பி',
      icon: 'https://media.graphassets.com/srotfmaaQo6SbHxaJuVV',
      link: '/treatments/hysteroscopy-treatment-in-hosur',
    },
    {
      id: '8',
      name: 'உறைவு கருவுறுப்பு மாற்று',
  ...
  male: [
    {
      id: '1',
      name: 'பி.இ.எஸ்.ஏ & டி.இ.எஸ்.ஏ முறைகள்',
    ...
    {
      id: '5',
      name: 'பிற ஆண் தொடர்பான சிகிச்சைகள்',
