  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name='description'
          content='கர்ப்பகுடி என்பது கனவுகள் உயிர்பெறும், நம்பிக்கைகள் ஒருபோதும் மங்காது, சாத்தியக்கூறுகள் ஒருபோதும் முடிவடையாத இடம். உங்கள் மகிழ்ச்சியின் உச்சத்தை வைத்திருக்கும் பொன்னான தருணத்தை அனுபவப்பதிற்கு நாங்கள் உங்களுக்கு உதவுகிறோம்'
        />
        {/* Open Graph / Facebook */}
