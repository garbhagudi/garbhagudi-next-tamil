  ...
  return (
    <div>
      <Head>
        ...
        <title>ஓசூரில் சிறந்த மகப்பேறு சிகிச்சை</title>
        <meta name='title' content='ஓசூரில் சிறந்த மகப்பேறு சிகிச்சை' />
        <meta
          name='description'
        ...
        <meta name='twitter:title' content='ஓசூரில் சிறந்த மகப்பேறு சிகிச்சை' />
        <meta
      ...
      <div className=''>
        <div className='mx-auto bg-transparent py-10 lg:py-16'>
          ...
          <div className='mx-auto max-w-5xl pt-6 font-content'>
            ...
            மையம், ஓசூர் தான் சரியான இடம். எங்களிடம் திறமையான மற்றும் அனுபவமிக்க கருத்தரிப்பு
            நிபுணர்கள் உள்ளனர். அவர்கள் உங்களுக்கு உயர்தர சிகிச்சை மற்றும் சிறந்த தீர்வுகளை வழங்க
            அர்ப்பணிப்புடன் செயல்படுகிறார்கள்.
            <br />
            ஓசூரில் முன்னணி கருத்தரிப்பு மருத்துவமாக பெயர் பெற்ற கர்பகுடி இன்று பல தம்பதிகள்
